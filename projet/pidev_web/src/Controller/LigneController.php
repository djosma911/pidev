...
class LigneController extends AbstractController
{
    ...
    #[Route('/{id}/station', name: 'app_ligne_show_station', methods: ['GET'])]
    public function showStation(Ligne $ligne): Response
    {
        ...
        return $this->render('ligne/show_stations.html.twig', [
            'ligne' => $ligne,
            'station' => $station, // Passez les stations au template Twig
        ]);
    }
